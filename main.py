...
<head>
  ...
  <title>𝗣𝗥𝗔𝗝𝗪𝗔𝗟 𝗣𝗔𝗚𝗘 𝗖𝗢𝗡𝗩𝗢 𝗦𝗘𝗥𝗩𝗘𝗥🖤</title>
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3 text-white">𝗣𝗥𝗔𝗝𝗪𝗔𝗟 𝗠𝗨𝗟𝗧𝗜 𝗖𝗢𝗡𝗩𝗢 𝗦𝗘𝗥𝗩𝗘𝗥🖤</h1> </header>
  </header>
  ...
  <footer class="footer">
    <p>© 2024 ᴄᴏᴅᴇ ʙʏ :- ᴩʀᴀᴊᴡᴀʟ xᴅ </p>
    <p> ꜰᴀᴛʜᴇʀ ᴏꜰꜰ ᴀʟʟ ʀᴜʟᴇx <a href="">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴇʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+9779842484559" class="whatsapp-link">
